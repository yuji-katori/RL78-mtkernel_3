...
#define TK_WAKEUP_MAXCNT		(32767)			/* Maximum queuing number of the task wakeup requests. */
#define TK_SEMAPHORE_MAXCNT		(32767)			/* Maximum semaphore count */
/*
 * Maximum queuing count of the forced wait of tasks.
 */
#define TK_SUSPEND_MAXCNT		(32767)
 ...
 * Subsystem
 */
#define TK_SUPPORT_SUBSYSTEM		TRUE			/* Support of subsystem */
