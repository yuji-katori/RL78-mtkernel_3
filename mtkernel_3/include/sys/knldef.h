 ...
 *
 *----------------------------------------------------------------------
 *    Modified by Yuji Katori at 2024/2/27.
 *----------------------------------------------------------------------
 */
 ...
 */
#if ( CFN_TIMER_PERIOD < MIN_TIMER_PERIOD || CFN_TIMER_PERIOD > MAX_TIMER_PERIOD )
# error "CFN_TIMER_PERIOD is out of range."
#endif

#if CFN_MAX_TSKPRI < 16
 ...
 */
#define	SYSTEMAREA_TOP	CFN_SYSTEMAREA_TOP
#define SYSTEMAREA_END	CFN_SYSTEMAREA_END
...
#define MAX_TSKPRI	(CFN_MAX_TSKPRI)	/* Maximum priority number = lowest priority */
#define NUM_TSKPRI	(CFN_MAX_TSKPRI)	/* Number of priority levels */
...
/* System Timer period
 */
#define	TIMER_PERIOD	CFN_TIMER_PERIOD
 ...
 */
#if USE_DEVICE
#define MAX_REGDEV	(CFN_MAX_REGDEV)
#define MAX_OPNDEV	(CFN_MAX_OPNDEV)
#define MAX_REQDEV	(CFN_MAX_REQDEV)
#define DEVT_MBFSZ0	(CFN_DEVT_MBFSZ0)
#define DEVT_MBFSZ1	(CFN_DEVT_MBFSZ1)
#else
#define MAX_REGDEV	(0)
#endif /* USE_DEVICE */
 ...
 */
#define EXC_STACK_SIZE	CFN_EXC_STACK_SIZE
#define	TMP_STACK_SIZE	CFN_TMP_STACK_SIZE

/*---------------------------------------------------------------------- */
/* Version Number
 */
#define VER_MAKER	CFN_VER_MAKER
#define VER_PRID	CFN_VER_PRID
#define VER_MAJOR	3
#define VER_MINOR	0
#define VER_SPVER	(0x6000 | (VER_MAJOR << 8) | VER_MINOR)
#define VER_PRVER	CFN_VER_PRVER
#define VER_PRNO1	CFN_VER_PRNO1
#define VER_PRNO2	CFN_VER_PRNO2
#define VER_PRNO3	CFN_VER_PRNO3
#define VER_PRNO4	CFN_VER_PRNO4
