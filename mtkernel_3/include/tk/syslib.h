...
#ifdef CLANGSPEC
IMPORT ER CreateLock( FastLock *lock, CONST VB *name );
#else
...
#ifdef CLANGSPEC
IMPORT ER CreateMLock( FastMLock *lock, CONST VB *name );
#else
