 ...
 *	syslib.h
 *
 *	micro T-Kernel System Library  (RL78/S3 core depended)
 */
...
#define isDI(intsts)		( ((intsts) & 0x0006) != 0 )

#define INTLEVEL_DI		(MAX_INT_PRI_PSW)
#define INTLEVEL_EI		(3)
